...
import imagenLight from '../img/bg-desktop-light.jpg'
import mobileImagenLight from '../img/bg-mobile-light.jpg'
import imgDark from '../img/bg-desktop-dark.jpg'
import imgDarkMobile from '../img/bg-mobile-dark.jpg'
...
const Navbar = () => {
  ...
  const handleDark = () => {
    ...
    localStorage.setItem('dark', body)
  }

  if(localStorage.getItem('dark') == "[object HTMLBodyElement]"){
    body.classList.add('dark');
  } else {
  ...
  return (
    <nav className='nav'>
        <div className="contenedorImg">
            <img className='img' src={imagenLight} alt="" />
            <img className='imgMobile' src={mobileImagenLight} alt="" />
            <img className='imgDark' src={imgDark} alt="" />
            <img className='imgDarkMobile' src={imgDarkMobile} alt="" />
        </div>
        <div className="contenedorTextos">
            <h1 className='titulo'>TODO</h1>
            <button onClick={handleDark} className={'darkBoton'}>
            ...
            <button onClick={handleLigth} className={'ligthBoton'}>
